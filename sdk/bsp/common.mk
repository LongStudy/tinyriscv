...
RISCV_TOOLS_PREFIX := riscv-none-elf-

RISCV_GCC     := $(RISCV_TOOLS_PREFIX)gcc
RISCV_AS      := $(RISCV_TOOLS_PREFIX)as
RISCV_GXX     := $(RISCV_TOOLS_PREFIX)g++
RISCV_OBJDUMP := $(RISCV_TOOLS_PREFIX)objdump
RISCV_GDB     := $(RISCV_TOOLS_PREFIX)gdb
RISCV_AR      := $(RISCV_TOOLS_PREFIX)ar
RISCV_OBJCOPY := $(RISCV_TOOLS_PREFIX)objcopy
RISCV_READELF := $(RISCV_TOOLS_PREFIX)readelf
